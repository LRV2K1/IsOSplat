...
rasterize_forward = _make_lazy_cuda_func("rasterize_forward")
nd_rasterize_forward = _make_lazy_cuda_func("nd_rasterize_forward")
distCUDA2 = _make_lazy_cuda_func("distCUDA2")
extract_segment_features = _make_lazy_cuda_func("extract_segment_features")
padd_features = _make_lazy_cuda_func("padd_features")
opening = _make_lazy_cuda_func("opening")
closing = _make_lazy_cuda_func("closing")
dilation = _make_lazy_cuda_func("dilation")
erosion = _make_lazy_cuda_func("erosion")
filter = _make_lazy_cuda_func("filter")
