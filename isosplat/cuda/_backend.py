...
try:
    ...
    from isosplat import csrc as _C
except ImportError:
    ...
    if cuda_toolkit_available():
        ...
        if os.path.exists(os.path.join(build_dir, "isosplat_cuda.so")) or os.path.exists(
            os.path.join(build_dir, "isosplat_cuda.lib")
        ):
        ...
        Console().print(
            "[yellow]isosplat: No CUDA toolkit found. isosplat will be disabled.[/yellow]"
        )
