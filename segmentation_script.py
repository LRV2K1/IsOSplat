...
iterations = 2
data = ["hornsD"] #"fountainD"] #, "fernD", "hornsD", "roomD", "fortressD", "leavesD", "flowerD", "orchidsD", "trexD"]
...
def main():
    ...
    for d in data:
        ...
        with open(record_path / "records.csv", "a", newline='') as record_file:
            writer = csv.writer(record_file, delimiter=';', quotechar='|', quoting=csv.QUOTE_MINIMAL)
            writer.writerow(["n_objects_1", "n_objects_2", "n_objects_3", "s_objects_1", "s_objects_2", "s_objects_3", "threshold", "iteration"])
        ...
        for i in range(iterations + 1):
            ...
            with open(record_path / "records.csv", "a", newline='') as record_file:
                writer = csv.writer(record_file, delimiter=';', quotechar='|', quoting=csv.QUOTE_MINIMAL)
                writer.writerow([no_1, no_2, no_3, ob_1, ob_2, ob_3, threshold, i])
